...
/**
 * Panel lateral derecho con la ficha del cliente, notas rápidas y etiquetar
 * resultado. Coexiste con el CallStage central — NO duplica los controles
 * mute/hold/colgar (esos están en el stage).
 */
export function ActiveCallPanel({ open, onClose }: ActiveCallPanelProps) {
  ...
  return (
    <div
      className="fixed bottom-0 right-0 top-0 z-[45] flex w-[420px] animate-df-slidein flex-col border-l border-df-border bg-df-surface shadow-[0_14px_40px_rgba(13,37,66,.16)]"
      role="dialog"
      aria-label="Ficha de cliente durante la llamada"
    >
